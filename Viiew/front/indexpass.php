...
// Vérifiez si l'ID du pass est passé dans l'URL
if (isset($_GET['id'])) {
    $pass_id = $_GET['id'];
    ...
    $trajets = $trajetController->afficherTrajets($pass_id);
} else {
...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            ...
            <a href="indexpass.php?id=<?php echo htmlspecialchars($pass_id); ?>" class="nav-item nav-link active">Accueil</a>
                        ...
                        <div class="container">
                            <div class="row align-items-center justify-content-center justify-content-lg-start">
                                <div class="col-10 col-lg-7 text-center text-lg-start">
                                    ...
                                    <h1 class="display-3 text-white mb-4 pb-3 animated slideInDown"> Prêt à partir pour votre prochaine destination ?</h1>
